...
namespace CollectionViewSource.Views
{
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            Customers = Customer.GenerateCustomers(200)
                .OrderBy(c => c.LastName)
                .ThenBy(c => c.FirstName)
                .ToList();

            var grouped = from customer in Customers
                group customer by customer.LastName
                into grp
                orderby grp.Key
                select new CustomerGroup
                {
                    LastName = grp.Key, Customers = grp.ToList()
                };

            CustomerGroups = grouped.ToList();
        }
